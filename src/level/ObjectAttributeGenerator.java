    ...
    public static void addAttributeForObject(GameObject objectOnTile,
        ...
        if (objectOnTile instanceof PeacefulRat) {
            ...
            String attributeValue =
                    generateSterilisationAttribute(sterilisation);
            ...
            if (objectOnTile instanceof MaleSexChanger) {
                ...
                attributeValue =
                        generateMaleSexChangeAttribute(maleSexChanger);
            } else {
                FemaleSexChanger femaleSexChanger =
                        (FemaleSexChanger) objectOnTile;
                attributeValue =
                        generateFemaleSexChangeAttribute(femaleSexChanger);
            }
