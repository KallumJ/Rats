...
public class MssgOfTheDay {
     ...
     *
     * The request made is a generic HTTP GET, response is then parsed, and only
     ...
     * @return              the body of the HTTP response from the supplied URI,
     *                      as string
    ...
    private static char charShift(final char ch, final int shift) {
        final int aToZLength = 1 + (int) ('Z' - 'A');
        final int valueA = (int) 'A';
