...
import display.menus.editor.MediumLevelEditorOptionsMenu;
 ...
 */
public class MediumCustomBoard extends Board {
    private final TileCanvas tileCanvas;
    private final LevelData levelData;
    private final MediumLevelEditorOptionsMenu inputMenu;
     ...
     */
    public MediumCustomBoard(LevelData levelData) {
        this.levelData = levelData;
        this.tileCanvas = new TileCanvas(levelData);
        this.inputMenu = new MediumLevelEditorOptionsMenu();
        this.eventListeners();
        levelOptionsStage = new Stage();
        levelOptionsStage.setScene(new Scene(inputMenu.buildGUI()));
        levelOptionsStage.setX(GameMenu.getStage().getX() - MediumLevelEditorOptionsMenu.WINDOW_OFFSET);
