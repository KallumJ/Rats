...
/**
 * Models a menu in the GUI. This class is extended by all other menus in the
 * system.
 *
...
public abstract class GameMenu {
    ...
    public BorderPane buildBlank(MenuTitle menuTitle, EventHandler<Event> backHandler) {
        ...
        if (backHandler != null) {
            ...
            backButton.setTranslateX(ON_CLICK_OFFSET);
            backButton.setTranslateY(ON_CLICK_OFFSET);
