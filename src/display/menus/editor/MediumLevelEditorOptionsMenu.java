 ...
 */
public class MediumLevelEditorOptionsMenu {
     ...
     */
    public MediumLevelEditorOptionsMenu() {
        populationToLoseTextField = new TextField("40");
        expectedTimeTextField = new TextField("200");
        itemIntervalTextField = new TextField("15");
        ratMaxBabiesTextField = new TextField("20");
        ratMinBabiesTextField = new TextField("5");
        adultRatSpeedTextField = new TextField("3000");
        babyRatSpeedTextField = new TextField("2000");
        deathRatSpeedTextField = new TextField("4000");
        tileSelectChoiceBox = new ChoiceBox<>();
        includeAirstrike = new RadioButton("Include airstrike");
        airstrikeCostTextField = new TextField("100");
        airstrikeNumberOfHitsTextField = new TextField("20");
