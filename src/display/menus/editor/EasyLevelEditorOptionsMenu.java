 ...
 */
public class EasyLevelEditorOptionsMenu {
     ...
     */
    public EasyLevelEditorOptionsMenu() {
        populationToLoseTextField = new TextField("20");
        expectedTimeTextField = new TextField("120");
        itemIntervalTextField = new TextField("10");
        ratMaxBabiesTextField = new TextField("15");
        ratMinBabiesTextField = new TextField("2");
        adultRatSpeedTextField = new TextField("2000");
        babyRatSpeedTextField = new TextField("1000");
        deathRatSpeedTextField = new TextField("3000");
        tileSelectChoiceBox = new ChoiceBox<>();
        includeAirstrike = new RadioButton("Include airstrike");
        airstrikeCostTextField = new TextField("50");
        airstrikeNumberOfHitsTextField = new TextField("10");
